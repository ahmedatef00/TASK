                                ...
                                <table class="table text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-col"><img src="{{url('images').'/'.$post->img}}"
                                                    style="width: 100px; height: 75px;" alt=""></td>
                                            ...
                                            <td class="row justify-content-center align-items-center"
                                                ...
                                                <a href="{{route('posts.edit', $post->id)}}"
                                                    class="btn btn-sm btn-info mr-2"><i class="fa fa-edit"></i> Edit</a>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <div class="input-group mt-4">
                                                <label for="users" class="bmd-label-floating"
                                                    for="inputGroupSelect01">Users</label>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_brief" class="form-control" cols="30"
                                                rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
