        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="checkbox" name="show[]" value="{{$page->id}}" class="form-check-input" id="{{str_replace(' ', '-', $page->feature)}}" {{$page->show == 1 ? 'checked' : ''}}>
                    <label class="form-check-label" for="{{str_replace(' ', '-', $page->feature)}}">{{$page->feature}}</label>
                </div>
